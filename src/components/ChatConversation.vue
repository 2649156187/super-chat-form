...
import type { ChatCard, ChatConversation, ChatMessage, ChatRendererProps } from '../types/chat';
...
const props = defineProps<{
  ...
  rendererMap?: Record<string, unknown>;
}>();
...
const builtinRendererMap: Record<string, unknown> = {
  text: TextRenderer,
...
<template>
  <section class="chat-wrapper">
    <div class="chat-list">
      ...
      >
        <component
          :is="resolveRenderer(message.type)"
          v-bind="{ message } as ChatRendererProps"
          @card-click="appendReviewMessage"
        />
      </article>
    </div>
